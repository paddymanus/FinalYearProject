package com.example.paddy.finalyearproject;
...
import com.example.paddy.finalyearproject.adapters.SetRecyclerAdapter;
...
import com.example.paddy.finalyearproject.persistence.ExerciseSetRepository;
...
//            exerciseSet.setNumber(mSetNumber.getText().toString());
    ...
    public String getStats() {
        ...
        for (int i = 0; i <= lvPosition - fvPosition; i++) {
            ...
            result = result.concat(String.valueOf(eSet.getWeight())
                    + "x" + String.valueOf(eSet.getReps()));
        }
        return result;
